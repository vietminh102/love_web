...
from app.models.nosql import Diary, Gallery, Notification, WheelData, Reminder
...
async def connect_to_mongo():
    try:
        ...
        await init_beanie(database=mongodb.db, document_models=[Diary, Gallery, Notification,WheelData,Reminder])
